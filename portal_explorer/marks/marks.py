...
from portal_explorer.constants import MARKS_URL, VIEW_MARKS_URL, HEADERS
from portal_explorer.marks.model.marks_model import MarksModel
from portal_explorer.parsers.marks_parser import parse_marks
