...
from portal_explorer.exam_schedule.model.exam_schedule_model import ExamScheduleModel
from portal_explorer.parsers.exam_schedule_parser import parse_exam_schedule
