...
from portal_explorer.exceptions.exception import VtopCaptchaError

try:
    weights_data_str = importlib.resources.read_text('portal_explorer.resources', 'weights.json')
