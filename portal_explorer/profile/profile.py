import httpx
import time
from portal_explorer.constants import PROFILE_URL, HEADERS
from portal_explorer.mentor import fetch_mentor_info
from portal_explorer.grade_history import fetch_grade_history
from portal_explorer.parsers.profile_parser import parse_student_profile
from .model import StudentProfileModel

from portal_explorer.exceptions import VtopConnectionError, VtopProfileError, VtopParsingError
