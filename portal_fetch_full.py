...
from portal_explorer.constants import SemSubID
from portal_explorer.exceptions import (
    PortalExplorerError,
    VtopLoginError,
    VtopAttendanceError,
)
...
async def fetch_semester_details(client: PortalSession, sem_name: str, sem_id: str):
...
async def main():
    ...
    async with PortalSession(username, password, timeout=timeout) as client:
        try:
            ...
            for sem_name, sem_id in SemSubID.items():
                ...
                except (VtopAttendanceError, PortalExplorerError, Exception):
                    continue
